class ZCB_ZAVE_STUDENT_P definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_STUDENT_ID type ZAVE_STUD_ID
    returning
      value(RESULT) type ref to ZCL_ZAVE_STUDENT_P
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_ZAVE_STUDENT_P .
  types:
    begin of TYP_BUSINESS_KEY ,
      STUDENT_ID type ZAVE_STUD_ID ,
  ...
  types:
    begin of TYP_DB_DATA ,
      STUDENT_ID type ZAVE_STUD_ID ,
      FIRSTNAME type ZAVE_STUD_FIRST_NAME ,
      LASTNAME type ZAVE_STUD_LAST_NAME ,
      PHONE type ZAVE_STUD_PHONE ,
      EMAIL type ZAVE_STUD_EMAIL ,
      ADDRESS type ZAVE_STUD_ADDRESS ,
      AVERAGE_MARK type ZAVE_STUD_AVG_MARK ,
      ELLIGIBLE type /MSG/R_KZ_JN ,
    end of TYP_DB_DATA .
  types:
...
CLASS ZCB_ZAVE_STUDENT_P IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_STUDENT_ID TYPE ZAVE_STUD_ID
*      RETURNING RESULT TYPE REF TO ZCL_ZAVE_STUDENT_P
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-STUDENT_ID = I_STUDENT_ID.
*>
...
*<  Generated from mapping:
          THE_OBJECT->STUDENT_ID = I_STUDENT_ID.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_STUDENT_ID = BUSINESS_KEY-STUDENT_ID
...
*<Generated from mapping:
  E_BUSINESS_KEY-STUDENT_ID  = I_DB_DATA-STUDENT_ID.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ZAVE_STUDENT_P,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-STUDENT_ID = THE_OBJECT->STUDENT_ID.
    OBJECT_DATA_ITEM-FIRSTNAME = THE_OBJECT->FIRSTNAME.
    OBJECT_DATA_ITEM-LASTNAME = THE_OBJECT->LASTNAME.
    OBJECT_DATA_ITEM-PHONE = THE_OBJECT->PHONE.
    OBJECT_DATA_ITEM-EMAIL = THE_OBJECT->EMAIL.
    OBJECT_DATA_ITEM-ADDRESS = THE_OBJECT->ADDRESS.
    OBJECT_DATA_ITEM-AVERAGE_MARK = THE_OBJECT->AVERAGE_MARK.
    OBJECT_DATA_ITEM-ELLIGIBLE = THE_OBJECT->ELLIGIBLE.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'STUDENT_ID'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'STUDENT_ID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'FIRSTNAME'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'FIRSTNAME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LASTNAME'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LASTNAME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PHONE'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PHONE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'EMAIL'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'EMAIL'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ADDRESS'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ADDRESS'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'AVERAGE_MARK'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'AVERAGE_MARK'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ELLIGIBLE'.
    MAP_ATT_INFO-EXPOSURE = '0'.
    MAP_ATT_INFO-RECORDNAME = 'ZAVE_FPM_STUD'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ELLIGIBLE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ZAVE_STUDENT_P.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->STUDENT_ID,
             THE_OBJECT->FIRSTNAME,
             THE_OBJECT->LASTNAME,
             THE_OBJECT->PHONE,
             THE_OBJECT->EMAIL,
             THE_OBJECT->ADDRESS,
             THE_OBJECT->AVERAGE_MARK,
             THE_OBJECT->ELLIGIBLE.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZAVE_FPM_STUD.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZAVE_FPM_STUD> type ZAVE_FPM_STUD.
*>

*< Generated from mapping:
  select * from ZAVE_FPM_STUD
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZAVE_FPM_STUD>.

*< Generated from mapping:
    DB_DATA-STUDENT_ID = <FS_DB_ZAVE_FPM_STUD>-STUDENT_ID.
    DB_DATA-FIRSTNAME = <FS_DB_ZAVE_FPM_STUD>-FIRSTNAME.
    DB_DATA-LASTNAME = <FS_DB_ZAVE_FPM_STUD>-LASTNAME.
    DB_DATA-PHONE = <FS_DB_ZAVE_FPM_STUD>-PHONE.
    DB_DATA-EMAIL = <FS_DB_ZAVE_FPM_STUD>-EMAIL.
    DB_DATA-ADDRESS = <FS_DB_ZAVE_FPM_STUD>-ADDRESS.
    DB_DATA-AVERAGE_MARK = <FS_DB_ZAVE_FPM_STUD>-AVERAGE_MARK.
    DB_DATA-ELLIGIBLE = <FS_DB_ZAVE_FPM_STUD>-ELLIGIBLE.
*>
...
*< Generated from mapping:
  select * from ZAVE_FPM_STUD
           ...
           where ZAVE_FPM_STUD~STUDENT_ID =
           I_BUSINESS_KEY_TAB-STUDENT_ID.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-STUDENT_ID = BUSINESS_KEY-STUDENT_ID.
*>
...
* * ZAVE_FPM_STUD: internal tables for mass operation
  data DB_ITB_ZAVE_FPM_STUD type STANDARD TABLE OF ZAVE_FPM_STUD.
  data DB_UTB_ZAVE_FPM_STUD type STANDARD TABLE OF ZAVE_FPM_STUD.
  data DB_DTB_ZAVE_FPM_STUD type STANDARD TABLE OF ZAVE_FPM_STUD.

* * ZAVE_FPM_STUD: headlines for tables
  data DB_ILN_ZAVE_FPM_STUD type ZAVE_FPM_STUD.
  data DB_ULN_ZAVE_FPM_STUD type ZAVE_FPM_STUD.
  data DB_DLN_ZAVE_FPM_STUD type ZAVE_FPM_STUD.
...
*< Generated from mapping:
   ...
   DB_ILN_ZAVE_FPM_STUD-FIRSTNAME = <FS_INSERT>-FIRSTNAME.
   DB_ILN_ZAVE_FPM_STUD-LASTNAME = <FS_INSERT>-LASTNAME.
   DB_ILN_ZAVE_FPM_STUD-PHONE = <FS_INSERT>-PHONE.
   DB_ILN_ZAVE_FPM_STUD-EMAIL = <FS_INSERT>-EMAIL.
   DB_ILN_ZAVE_FPM_STUD-ADDRESS = <FS_INSERT>-ADDRESS.
   DB_ILN_ZAVE_FPM_STUD-AVERAGE_MARK = <FS_INSERT>-AVERAGE_MARK.
   DB_ILN_ZAVE_FPM_STUD-ELLIGIBLE = <FS_INSERT>-ELLIGIBLE.


   DB_ILN_ZAVE_FPM_STUD-STUDENT_ID = <FS_INSERT>-STUDENT_ID.
   append DB_ILN_ZAVE_FPM_STUD to DB_ITB_ZAVE_FPM_STUD.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZAVE_FPM_STUD-FIRSTNAME = <FS_UPDATE>-FIRSTNAME.
   DB_ULN_ZAVE_FPM_STUD-LASTNAME = <FS_UPDATE>-LASTNAME.
   DB_ULN_ZAVE_FPM_STUD-PHONE = <FS_UPDATE>-PHONE.
   DB_ULN_ZAVE_FPM_STUD-EMAIL = <FS_UPDATE>-EMAIL.
   DB_ULN_ZAVE_FPM_STUD-ADDRESS = <FS_UPDATE>-ADDRESS.
   DB_ULN_ZAVE_FPM_STUD-AVERAGE_MARK = <FS_UPDATE>-AVERAGE_MARK.
   DB_ULN_ZAVE_FPM_STUD-ELLIGIBLE = <FS_UPDATE>-ELLIGIBLE.


   DB_ULN_ZAVE_FPM_STUD-STUDENT_ID = <FS_UPDATE>-STUDENT_ID.
   append DB_ULN_ZAVE_FPM_STUD TO DB_UTB_ZAVE_FPM_STUD.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZAVE_FPM_STUD-STUDENT_ID =
    <FS_DELETE>-BUSINESS_KEY-STUDENT_ID.

    append DB_DLN_ZAVE_FPM_STUD TO DB_DTB_ZAVE_FPM_STUD.
...
* * DB Deletes
  delete ZAVE_FPM_STUD FROM TABLE DB_DTB_ZAVE_FPM_STUD.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZAVE_FPM_STUD FROM TABLE DB_ITB_ZAVE_FPM_STUD
...
* * DB Updates
  update ZAVE_FPM_STUD FROM TABLE DB_UTB_ZAVE_FPM_STUD.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-STUDENT_ID.
...
*<  Generated from mapping:
  THE_OBJECT->STUDENT_ID = I_OBJECT_DATA-STUDENT_ID.
  THE_OBJECT->FIRSTNAME = I_OBJECT_DATA-FIRSTNAME.
  THE_OBJECT->LASTNAME = I_OBJECT_DATA-LASTNAME.
  THE_OBJECT->PHONE = I_OBJECT_DATA-PHONE.
  THE_OBJECT->EMAIL = I_OBJECT_DATA-EMAIL.
  THE_OBJECT->ADDRESS = I_OBJECT_DATA-ADDRESS.
  THE_OBJECT->AVERAGE_MARK = I_OBJECT_DATA-AVERAGE_MARK.
  THE_OBJECT->ELLIGIBLE = I_OBJECT_DATA-ELLIGIBLE.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ZAVE_STUDENT_P.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->STUDENT_ID = I_BUSINESS_KEY-STUDENT_ID.
* >
